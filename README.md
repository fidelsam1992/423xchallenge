# {code} by Dell Technologies Hackathon

## The Mars Challenge

![Planet Mars](documentation/images/mars-11608_640.jpg)
...
![Mars Challenge High Level Architecture](documentation/images/Mars-challenge-high-level-architecture.png)
...
- Team solutions need to connect to the Mars Challenge [Game Controller](https://github.com//fidelsam1992/423xchallenge/tree/master/game-controller)
...
**For more details refer to the: [Mars Challenge Instructions document](https://github.com//fidelsam1992/423xchallenge/blob/master/documentation/Mars-challenge-instructions.md)**
