...
server_url = 'http://127.0.0.1:8080/api'   # URL of the SERVER API
server_ws = 'ws://127.0.0.1:8080/ws'       # URL of the Sensors Websocket
...
def team_shield_up(team_name, team_auth):
    ...
    curl -i -H 'X-Auth-Token: 1335aa6af5d0289f' -X POST http://127.0.0.1:8080/api/shield/enable
    :param team_name:The team name
...
def team_shield_down(team_name, team_auth):
    ...
    curl -i -H 'X-Auth-Token: 1335aa6af5d0289f' -X POST http://127.0.0.1:8080/api/shield/disable
    :param team_name:The team name
    :param team_auth:The team authentication token
    :return: nothing
    """
